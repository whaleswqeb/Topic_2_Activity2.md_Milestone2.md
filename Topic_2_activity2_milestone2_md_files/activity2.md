...
The following command was executed: npm install -g @angular/cli
After Installation, I verified the installation using : ng version
...
Routing.
2. I chose CSS as my stylesheet format.The Angular CLI created a full project structure, which contained all configuration files, dependencies and starter components, automatically.
...
To start the development server, execute below command: ng serve -o
This command:
...
version It helpful when someone run the npm install command it loads the
